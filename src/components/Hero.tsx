  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative z-0 pt-20 bg-gradient-to-br from-slate-100 via-slate-50 to-blue-50 dark:from-background dark:via-slate-900/60 dark:to-blue-500/5">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[50vw] h-[40vh] rounded-[50%] bg-blue-200/40 blur-3xl animate-wander-1 dark:bg-blue-800/50" />
        <div className="absolute right-1/4 bottom-1/3 w-[45vw] h-[35vh] bg-purple-200/35 rounded-[60%] blur-3xl animate-wander-2 dark:bg-purple-800/45" />
        <div className="absolute left-1/3 top-1/4 w-[40vw] h-[30vh] bg-blue-100/30 rounded-[70%] blur-2xl animate-wander-3 dark:bg-blue-900/40" />
        <div className="absolute right-1/3 top-2/3 w-[35vw] h-[25vh] bg-purple-100/25 rounded-[80%] blur-2xl animate-wander-4 dark:bg-purple-900/35" />
      </div>
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className={`text-center animate-on-scroll scale-in stagger-4 ${isIntersecting ? 'visible' : ''} hover:scale-110 duration-300 cursor-pointer animate-float`}>
              ...
              <div className={`text-center animate-on-scroll scale-in stagger-5 ${isIntersecting ? 'visible' : ''} hover:scale-110 duration-300 cursor-pointer animate-float-reverse`}>
              ...
              <div className={`text-center animate-on-scroll scale-in stagger-6 ${isIntersecting ? 'visible' : ''} hover:scale-110 duration-300 cursor-pointer animate-float`}>
          ...
          <div className={`relative animate-on-scroll fade-in-right ${isIntersecting ? 'visible' : ''} animate-drift`}>
              ...
              <div className="bg-white/60 dark:bg-slate-800/60 rounded-2xl p-12 backdrop-blur-lg border border-slate-200/40 dark:border-slate-700/40">
                <div className="space-y-10">
                  ...
                  <div className="space-y-6">
                    <div className="bg-white/70 dark:bg-slate-700/50 rounded-lg p-6 hover:bg-white/90 dark:hover:bg-slate-700/70 duration-300 border border-slate-200/30 dark:border-slate-600/30 animate-pulse-slow">
                      <div className="flex justify-between items-center">
                        <span className="text-lg">Efficienza Processi</span>
                        <span className="text-xl font-bold text-green-400">+89%</span>
                      </div>
                    </div>
                    <div className="bg-white/70 dark:bg-slate-700/50 rounded-lg p-6 hover:bg-white/90 dark:hover:bg-slate-700/70 duration-300 border border-slate-200/30 dark:border-slate-600/30 animate-pulse-slow" style={{ animationDelay: '0.2s' }}>
                      <div className="flex justify-between items-center">
                        <span className="text-lg">Riduzione Costi</span>
                        <span className="text-xl font-bold text-blue-400">-67%</span>
                      </div>
                    </div>
                    <div className="bg-white/70 dark:bg-slate-700/50 rounded-lg p-6 hover:bg-white/90 dark:hover:bg-slate-700/70 duration-300 border border-slate-200/30 dark:border-slate-600/30 animate-pulse-slow" style={{ animationDelay: '0.4s' }}>
                      <div className="flex justify-between items-center">
