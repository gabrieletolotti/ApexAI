  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative z-0 pt-20 px-4 bg-gradient-to-br from-slate-100 via-slate-50 to-blue-50 dark:from-background dark:via-slate-900/60 dark:to-blue-500/5">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="hero-bg-element-1 absolute w-[40vw] h-[25vh] md:w-[25vw] md:h-[20vh] rounded-full bg-blue-200/30 blur-3xl dark:bg-blue-800/40" style={{left: '5%', top: '15%'}} />
        <div className="hero-bg-element-2 absolute w-[45vw] h-[30vh] md:w-[30vw] md:h-[25vh] rounded-full bg-purple-200/25 blur-3xl dark:bg-purple-800/35" style={{right: '10%', bottom: '25%'}} />
        <div className="hero-bg-element-3 absolute w-[35vw] h-[20vh] md:w-[20vw] md:h-[15vh] rounded-full bg-blue-100/35 blur-2xl dark:bg-blue-900/45" style={{left: '25%', top: '55%'}} />
        <div className="hero-bg-element-4 absolute w-[50vw] h-[35vh] md:w-[35vw] md:h-[30vh] rounded-full bg-purple-100/20 blur-3xl dark:bg-purple-900/30" style={{right: '15%', top: '5%'}} />
        <div className="hero-bg-element-5 absolute w-[25vw] h-[15vh] md:w-[15vw] md:h-[12vh] rounded-full bg-blue-300/40 blur-2xl dark:bg-blue-700/50" style={{left: '55%', bottom: '35%'}} />
        
        {/* Elementi più piccoli per mobile */}
        <div className="hero-bg-element-1 absolute w-[20vw] h-[12vh] md:w-[10vw] md:h-[8vh] rounded-full bg-indigo-200/30 blur-xl dark:bg-indigo-800/40" style={{left: '3%', bottom: '15%', animationDelay: '-8s'}} />
        <div className="hero-bg-element-3 absolute w-[25vw] h-[15vh] md:w-[12vw] md:h-[10vh] rounded-full bg-cyan-200/25 blur-xl dark:bg-cyan-800/35" style={{right: '5%', top: '35%', animationDelay: '-12s'}} />
        <div className="hero-bg-element-5 absolute w-[15vw] h-[10vh] md:w-[8vw] md:h-[6vh] rounded-full bg-pink-200/35 blur-lg dark:bg-pink-800/45" style={{left: '65%', top: '20%', animationDelay: '-18s'}} />
      </div>
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              ...
              <p className={`text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 animate-on-scroll fade-in-up stagger-2 ${isIntersecting ? 'visible' : ''}`}>
          ...
          <div className={`relative animate-on-scroll fade-in-right ${isIntersecting ? 'visible' : ''} mt-8 lg:mt-0`}>
            <div className="bg-gradient-to-br from-white/80 to-slate-100/70 dark:from-slate-800/90 dark:to-slate-900/80 rounded-3xl p-8 lg:p-16 backdrop-blur-2xl border-2 border-slate-200/60 dark:border-slate-600/50 hover:scale-105 duration-500 shadow-2xl shadow-slate-400/20 dark:shadow-slate-900/40">
              <div className="bg-white/60 dark:bg-slate-800/60 rounded-2xl p-6 lg:p-12 backdrop-blur-lg border border-slate-200/40 dark:border-slate-700/40">
                <div className="space-y-6 lg:space-y-10">
                  <div className="flex items-center space-x-4">
                    <div className="w-4 h-4 lg:w-6 lg:h-6 bg-green-400 rounded-full"></div>
                    <span className="text-lg lg:text-xl font-medium">Sistema AI Attivo</span>
                  </div>
                  <div className="space-y-4 lg:space-y-6">
                    <div className="bg-white/70 dark:bg-slate-700/50 rounded-lg p-4 lg:p-6 hover:bg-white/90 dark:hover:bg-slate-700/70 duration-300 border border-slate-200/30 dark:border-slate-600/30">
                      <div className="flex justify-between items-center">
                        <span className="text-base lg:text-lg">Efficienza Processi</span>
                        <span className="text-lg lg:text-xl font-bold text-green-400">+89%</span>
                      </div>
                    </div>
                    <div className="bg-white/70 dark:bg-slate-700/50 rounded-lg p-4 lg:p-6 hover:bg-white/90 dark:hover:bg-slate-700/70 duration-300 border border-slate-200/30 dark:border-slate-600/30" style={{ animationDelay: '0.2s' }}>
                      <div className="flex justify-between items-center">
                        <span className="text-base lg:text-lg">Riduzione Costi</span>
                        <span className="text-lg lg:text-xl font-bold text-blue-400">-67%</span>
                      </div>
                    </div>
                    <div className="bg-white/70 dark:bg-slate-700/50 rounded-lg p-4 lg:p-6 hover:bg-white/90 dark:hover:bg-slate-700/70 duration-300 border border-slate-200/30 dark:border-slate-600/30" style={{ animationDelay: '0.4s' }}>
                      <div className="flex justify-between items-center">
                        <span className="text-base lg:text-lg">Automazione Completa</span>
                        <span className="text-lg lg:text-xl font-bold text-purple-400">24/7</span>
                      </div>
                    </div>
                  </div>
                </div>
