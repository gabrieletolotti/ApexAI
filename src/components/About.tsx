    ...
    <section id="about" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-[fade-in_0.8s_ease-out_0.2s_both]">
            <div>
              <h2 className="text-4xl font-bold mb-6 animate-[fade-in_0.8s_ease-out_0.4s_both]">
                Chi Siamo <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">ApexAI</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6 animate-[fade-in_0.8s_ease-out_0.6s_both]">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed animate-[fade-in_0.8s_ease-out_0.8s_both]">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl animate-[fade-in_0.8s_ease-out_1s_both] hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer">
                <div className="text-3xl font-bold text-blue-600 mb-2">50+</div>
                <div className="text-sm text-muted-foreground">Progetti Completati</div>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl animate-[fade-in_0.8s_ease-out_1.2s_both] hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer">
          ...
          <div className="space-y-6 animate-[fade-in_0.8s_ease-out_0.4s_both]">
            <div className="bg-gradient-to-br from-white to-blue-50 p-8 rounded-3xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500">
              <h3 className="text-2xl font-bold mb-6 text-center">Perché Scegliere ApexAI</h3>
              
              <div className="space-y-6">
                <div className="flex items-start space-x-4 animate-[fade-in_0.6s_ease-out_0.8s_both] hover:transform hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex items-start space-x-4 animate-[fade-in_0.6s_ease-out_1s_both] hover:transform hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex items-start space-x-4 animate-[fade-in_0.6s_ease-out_1.2s_both] hover:transform hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex items-start space-x-4 animate-[fade-in_0.6s_ease-out_1.4s_both] hover:transform hover:translate-x-2 transition-transform duration-300">
