...
const Header = () => {
  ...
  return (
    <header
      ref={ref}
      className={`mobile-header fixed left-1/2 -translate-x-1/2 mt-6 w-[95vw] max-w-4xl bg-white/10 backdrop-blur-xl z-50 border border-white/20 shadow-lg ${isIntersecting ? 'translate-y-0 opacity-100' : 'translate-y-0 opacity-100'}`}
      style={{ top: undefined }}
    >
