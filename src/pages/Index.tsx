  ...
  return (
    <div className="min-h-screen">
      ...
      {showScrollTop && (
        <Button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-40 rounded-full w-12 h-12 p-0 shadow-2xl hover:scale-110 transition-all duration-300 bg-blue-600 hover:bg-blue-700 opacity-100"
          aria-label="Torna su"
        >
          <ArrowUp size={24} />
        </Button>
